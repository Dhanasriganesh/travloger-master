...
const ladakhHighlights: HighlightImage[] = [
  { 
    id: '1', 
    src: highlight1, 
      ...
      <div className={mobileFirst.container('xl')}>
        ...
        <LazyLoad animationType="fade" delay={0.2}>
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
              Experience the most breathtaking destinations that make Ladakh truly magical
            </p>
          </div>
        </LazyLoad>
        ...
        <LazyLoad animationType="scale" delay={0.3}>
          <div className="relative">
            ...
            >
              {ladakhHighlights.map((slide, index) => (
                <SwiperSlide
                  key={slide.id}
