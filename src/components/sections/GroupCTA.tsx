                ...
                <div className="relative z-10 p-4 md:p-6 flex items-center min-h-[210px]">
                  ...
                  <div className="flex-1 max-w-md text-left">
                    ...
                    Travelling with 8 or more ?
                      <span className="text-white block sm:inline text-sm md:text-md font-normal font-cta">Enjoy a free photographer on your trip or unlock up to <span className="text-yellow-200 font-bold">40% off</span> as the trip planner.</span>
                    </h2>
