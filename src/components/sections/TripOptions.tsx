...
const TripOptions = React.memo(() => {
  ...
  // Get current trips based on active tab, with fallback
  ...
  }, [activeTab, customTrips, groupTrips]);
        ...
        <LazyLoad animationType="fade" delay={0.2}>
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
              Choose your perfect Kashmir adventure - customize your own journey or join our group departures
            </p>
          </div>
        </LazyLoad>
